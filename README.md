...
# Special thanks to:
- [Notusknot's NixOS Config](https://github.com/notusknot/dotfiles-nix)
...
```bash
git clone https://github.com/davidemarcoli/nixos-config ~/.config/nixos && cd ~/.config/nixos
```
...
And that should be it! If there are any issues, please don't hesitate to contact me.

## Conclusion
And thats about it for my configuration. The code is registered under the MIT license, meaning you are allowed to use or distribute the code as you please, and if you need any help or have any suggestions, you can reach me on Discord at `Leo1305` or email me at `davide@marcoli.ch`.
